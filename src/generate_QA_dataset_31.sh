...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_31                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_31.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_31.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/microbiology"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/microbiology/978-0323476768.csv"
