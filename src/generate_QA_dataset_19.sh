...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_19                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_19.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_19.err                                         # set error file name 
...
MAX_ENTRIES=675  # Set to desired number or leave blank for all
