...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_59                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_59.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_59.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=941  # Change this value to resume from a specific paragraph
MAX_ENTRIES=1880  # Set to desired number or leave blank for all
