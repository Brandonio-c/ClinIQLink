...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_33                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_33.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_33.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/clinical_skills"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/clinical_skills/978-1469893419.csv"
