...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_32                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_32.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_32.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/immunology"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/immunology/978-1003137658.csv"
