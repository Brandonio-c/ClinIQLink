...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_51                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_51.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_51.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=771  # Change this value to resume from a specific paragraph
MAX_ENTRIES=1540  # Set to desired number or leave blank for all
