...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_27                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_27.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_27.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/pathology"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/pathology/978-0721631585.csv"
...
CHECKPOINT=20
START_PARAGRAPH=1261  # Change this value to resume from a specific paragraph
