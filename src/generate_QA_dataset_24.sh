...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_24                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_24.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_24.err                                         # set error file name 
...
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/biochemistry/978-1260469943.csv"
...
CHECKPOINT=20
START_PARAGRAPH=811  # Change this value to resume from a specific paragraph
