...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_26                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_26.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_26.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=631  # Change this value to resume from a specific paragraph
MAX_ENTRIES=1261  # Set to desired number or leave blank for all
