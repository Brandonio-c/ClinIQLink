...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_37                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_37.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_37.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=1501  # Change this value to resume from a specific paragraph
