...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_15                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_15.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_15.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/anatomy"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/anatomy/978-1496347213.csv"
...
CHECKPOINT=20
START_PARAGRAPH=1681  # Change this value to resume from a specific paragraph
MAX_ENTRIES=2240  # Set to desired number or leave blank for all
