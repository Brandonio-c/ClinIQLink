...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_8                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_8.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_8.err                                         # set error file name 
...
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/public_health_and_preventive_medicine/978-0071376396.csv"
