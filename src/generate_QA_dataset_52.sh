...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_52                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_52.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_52.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/pediatrics"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/pediatrics/978-0323883054.csv"
...
CHECKPOINT=20
START_PARAGRAPH=1541  # Change this value to resume from a specific paragraph
