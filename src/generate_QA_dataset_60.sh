...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_60                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_60.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_60.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=1881  # Change this value to resume from a specific paragraph
MAX_ENTRIES=2820  # Set to desired number or leave blank for all
