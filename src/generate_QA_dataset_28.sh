...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_28                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_28.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_28.err                                         # set error file name 
...
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/pharmacology/978-1260117127.csv"
