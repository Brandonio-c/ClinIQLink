...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_50                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_50.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_50.err                                         # set error file name 
...
MAX_ENTRIES=770  # Set to desired number or leave blank for all
