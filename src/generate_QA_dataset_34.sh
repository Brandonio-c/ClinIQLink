...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_34                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_34.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_34.err                                         # set error file name 
...
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/clinical_skills/978-9395736435.csv"
