...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_30                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_30.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_30.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/pharmacology"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/pharmacology/978-1264258086.csv"
...
CHECKPOINT=20
START_PARAGRAPH=831  # Change this value to resume from a specific paragraph
