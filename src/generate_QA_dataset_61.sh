...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_61                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_61.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_61.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/gpsychiatry"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/psychiatry/preprocessed_data.csv"
...
CHECKPOINT=20
START_PARAGRAPH=2821  # Change this value to resume from a specific paragraph
MAX_ENTRIES=5000  # Set to desired number or leave blank for all
