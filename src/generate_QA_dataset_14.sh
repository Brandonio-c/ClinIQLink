...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_14                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_14.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_14.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=1121  # Change this value to resume from a specific paragraph
MAX_ENTRIES=1680  # Set to desired number or leave blank for all
