...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_29                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_29.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_29.err                                         # set error file name 
...
MAX_ENTRIES=830  # Set to desired number or leave blank for all
