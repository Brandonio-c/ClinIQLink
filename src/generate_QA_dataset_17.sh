...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_17                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_17.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_17.err                                         # set error file name 
...
MAX_ENTRIES=590  # Set to desired number or leave blank for all
