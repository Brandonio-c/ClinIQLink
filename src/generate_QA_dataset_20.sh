...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_20                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_20.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_20.err                                         # set error file name 
...
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/physiology/978-1865843834.csv"
...
CHECKPOINT=20
START_PARAGRAPH=676  # Change this value to resume from a specific paragraph
