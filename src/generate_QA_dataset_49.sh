...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_49                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_49.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_49.err                                         # set error file name 
...
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/surgery/978-1260469752.csv"
