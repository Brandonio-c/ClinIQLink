...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_56                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_56.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_56.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=2506  # Change this value to resume from a specific paragraph
