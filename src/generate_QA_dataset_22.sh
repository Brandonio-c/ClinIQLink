...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_22                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_22.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_22.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/biochemistry"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/biochemistry/978-9389859751.csv"
...
CHECKPOINT=20
START_PARAGRAPH=891  # Change this value to resume from a specific paragraph
