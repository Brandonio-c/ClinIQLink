...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_39                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_39.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_39.err                                         # set error file name 
...
CHECKPOINT=20
START_PARAGRAPH=4501  # Change this value to resume from a specific paragraph
MAX_ENTRIES=6000  # Set to desired number or leave blank for all
