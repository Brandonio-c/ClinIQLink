...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_18                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_18.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_18.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/physiology"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/physiology/978-1455770076.csv"
...
CHECKPOINT=20
START_PARAGRAPH=591  # Change this value to resume from a specific paragraph
MAX_ENTRIES=2000  # Set to desired number or leave blank for all
