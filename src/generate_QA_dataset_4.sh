...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_4                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_4.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_4.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/emergency_medicine"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/emergency_medicine/978-0071484800.csv"
...
CHECKPOINT=20
START_PARAGRAPH=1756  # Change this value to resume from a specific paragraph
