...
#SBATCH --job-name=generate_qa_dataset_llama3-3_70B_7                                          # Set job name
#SBATCH --output=generate_qa_dataset_llama3-3_70B_7.out                                        # Output file name
#SBATCH --error=generate_qa_dataset_llama3-3_70B_7.err                                         # set error file name 
...
DATA_DIR="$BASEDIR/data/public_health_and_preventive_medicine"
OUTPUT_DIR="$BASEDIR/QA_dataset"
PREPROCESSED_DATA_CSV="/data/coleloughbc/NIH_ACL_shared-task_LLM-lie-detector/ClinIQLink/preprocessed_dataset/public_health_and_preventive_medicine/978-0071441988.csv"
...
CHECKPOINT=20
START_PARAGRAPH=961  # Change this value to resume from a specific paragraph
MAX_ENTRIES=3000  # Set to desired number or leave blank for all
